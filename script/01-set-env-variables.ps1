...
$env:devCenterSubscriptionId="91e4cd90-811e-45d3-a068-670b6f14f580"
$env:devCenterResourceGroup="rg-devcenter-multisub-test-01"

$env:projectSubscriptionId="4c3f03bc-ab2c-4b0a-aa11-9fbc90cc7a58"
